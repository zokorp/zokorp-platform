...
- Open: https://github.com/leggoboyo/zokorp-platform/pull/39
- Auto-merge: enabled with squash merge
- Merge state: blocked pending required branch conditions/checks
