...
- Open PR: https://github.com/leggoboyo/zokorp-platform/pull/36
- Auto-merge: enabled with squash merge
- Current merge state: blocked only on required GitHub checks not having completed yet
